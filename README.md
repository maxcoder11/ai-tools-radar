...
**v1.0.1** · 数据快照 2026-08-26 · [更新日志](CHANGELOG.md)
...
| 视图 | 内容 |
|---|---|
| **总榜** | 20,459 个 AI 工具站，月访问量/自然搜索流量/环比增长/反链/全球排名/域名注册时间，点行展开详情抽屉（12 月流量曲线、渠道构成、头部关键词） |
...
data/data.json             # 站点榜单数据(20,459 行 / 13 MB)
